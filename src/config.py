...
NUM_AGENTS = 5
BATTERY_INITIAL = 500
# Con 1.20, la soglia diventa BATTERY_INITIAL * 0.10 * 1.20 = 60.
ENERGY_MARGIN = 1.20
EMERGENCY_DROP_BATTERY = 2

# -- Sensori e Comunicazione --
VISION_RADIUS = 3  # Configurazione C1: cambia questo (1 vs 3)
COMM_RADIUS = 2
# DEPLOY_RADIUS usato in try_spawn_next per cercare celle di spawn
# entro distanza Manhattan DEPLOY_RADIUS da (0,0).
DEPLOY_RADIUS = 1

# -- Stigmergia --
# CONGESTION_MALUS usato in evaluate_utility come penalita' per celle occupate.
CONGESTION_MALUS = 10
EVAPORATION_RATE = 0.05
# STIGMA_ON controllato in pathfinding.py e environment.py.
...
# STRESS_MAX e STRESS_RANDOM_STEPS usati in base_agent, scouts e workers.
